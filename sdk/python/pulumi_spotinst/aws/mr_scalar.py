...
class MrScalar(pulumi.CustomResource):
    ...
    core_desired_capacity: pulumi.Output[int]
    ...
    core_max_size: pulumi.Output[int]
    core_min_size: pulumi.Output[int]
    ...
    task_desired_capacity: pulumi.Output[int]
    ...
    task_max_size: pulumi.Output[int]
    task_min_size: pulumi.Output[int]
    ...
    def __init__(__self__, resource_name, opts=None, additional_info=None, additional_primary_security_groups=None, additional_replica_security_groups=None, applications=None, availability_zones=None, bootstrap_actions_files=None, cluster_id=None, configurations_files=None, core_desired_capacity=None, core_ebs_block_devices=None, core_ebs_optimized=None, core_instance_types=None, core_lifecycle=None, core_max_size=None, core_min_size=None, core_scaling_down_policies=None, core_scaling_up_policies=None, custom_ami_id=None, description=None, ebs_root_volume_size=None, ec2_key_name=None, expose_cluster_id=None, job_flow_role=None, keep_job_flow_alive=None, log_uri=None, managed_primary_security_group=None, managed_replica_security_group=None, master_ebs_block_devices=None, master_ebs_optimized=None, master_instance_types=None, master_lifecycle=None, name=None, provisioning_timeout=None, region=None, release_label=None, repo_upgrade_on_boot=None, retries=None, scheduled_tasks=None, security_config=None, service_access_security_group=None, service_role=None, steps_files=None, strategy=None, tags=None, task_desired_capacity=None, task_ebs_block_devices=None, task_ebs_optimized=None, task_instance_types=None, task_lifecycle=None, task_max_size=None, task_min_size=None, task_scaling_down_policies=None, task_scaling_up_policies=None, termination_protected=None, visible_to_all_users=None, __name__=None, __opts__=None):
        ...
        * `max_capacity` - (Optional) New max capacity for the elastigroup.
        ...
        :param pulumi.Input[str] additional_info
        :param pulumi.Input[list] additional_primary_security_groups
        :param pulumi.Input[list] additional_replica_security_groups
        :param pulumi.Input[list] applications
        :param pulumi.Input[list] availability_zones
        :param pulumi.Input[list] bootstrap_actions_files
        :param pulumi.Input[str] cluster_id: The MrScaler cluster id.
        :param pulumi.Input[list] configurations_files
        :param pulumi.Input[int] core_desired_capacity
        :param pulumi.Input[list] core_ebs_block_devices
        :param pulumi.Input[bool] core_ebs_optimized
        :param pulumi.Input[list] core_instance_types
        :param pulumi.Input[str] core_lifecycle
        :param pulumi.Input[int] core_max_size
        :param pulumi.Input[int] core_min_size
        :param pulumi.Input[list] core_scaling_down_policies
        :param pulumi.Input[list] core_scaling_up_policies
        :param pulumi.Input[str] custom_ami_id
        :param pulumi.Input[str] description: The MrScaler description.
        :param pulumi.Input[int] ebs_root_volume_size
        :param pulumi.Input[str] ec2_key_name
        :param pulumi.Input[bool] expose_cluster_id: Allow the `cluster_id` to set a Terraform output variable.
        :param pulumi.Input[str] job_flow_role
        :param pulumi.Input[bool] keep_job_flow_alive
        :param pulumi.Input[str] log_uri
        :param pulumi.Input[str] managed_primary_security_group
        :param pulumi.Input[str] managed_replica_security_group
        :param pulumi.Input[list] master_ebs_block_devices
        :param pulumi.Input[bool] master_ebs_optimized
        :param pulumi.Input[list] master_instance_types
        :param pulumi.Input[str] master_lifecycle
        :param pulumi.Input[str] name: The MrScaler name.
        :param pulumi.Input[dict] provisioning_timeout
        :param pulumi.Input[str] region: The MrScaler region.
        :param pulumi.Input[str] release_label
        :param pulumi.Input[str] repo_upgrade_on_boot
        :param pulumi.Input[int] retries
        :param pulumi.Input[list] scheduled_tasks
        :param pulumi.Input[str] security_config
        :param pulumi.Input[str] service_access_security_group
        :param pulumi.Input[str] service_role
        :param pulumi.Input[list] steps_files
        :param pulumi.Input[str] strategy: The MrScaler strategy. Allowed values are `new` `clone` and `wrap`.
        :param pulumi.Input[list] tags
        :param pulumi.Input[int] task_desired_capacity
        :param pulumi.Input[list] task_ebs_block_devices
        :param pulumi.Input[bool] task_ebs_optimized
        :param pulumi.Input[list] task_instance_types
        :param pulumi.Input[str] task_lifecycle
        :param pulumi.Input[int] task_max_size
        :param pulumi.Input[int] task_min_size
        :param pulumi.Input[list] task_scaling_down_policies
        :param pulumi.Input[list] task_scaling_up_policies
        :param pulumi.Input[bool] termination_protected
        :param pulumi.Input[bool] visible_to_all_users
        """
