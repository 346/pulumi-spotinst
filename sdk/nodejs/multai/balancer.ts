...
export class Balancer extends pulumi.CustomResource {
    ...
    public readonly connectionTimeouts: pulumi.Output<{ draining?: number, idle?: number } | undefined>;
    ...
    constructor(name: string, argsOrState?: BalancerArgs | BalancerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            const state: BalancerState = argsOrState as BalancerState | undefined;
        ...
        super("spotinst:multai/balancer:Balancer", name, inputs, opts);
    }
}
...
export interface BalancerState {
    readonly connectionTimeouts?: pulumi.Input<{ draining?: pulumi.Input<number>, idle?: pulumi.Input<number> }>;
